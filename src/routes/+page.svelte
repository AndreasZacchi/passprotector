...
<!--Ad text and button ment to lure people in-->
    <div class="flex flex-col w-12/12 h-3/3 p-8">
        <h1 class="text-4xl font-poppins font-bold text-main-200">
        ...
        <button type="button" 
        class="mt-11 bg-main-300 rounded-md h-10 w-60 font-poppins text-white ease-in duration-150 hover:bg-main-200">
            Try PassProtector for Free
        </button>
    </div>

<!--Picture example div, ment to show example of our website when logged in-->
    <div class="w-12/12 p-8">

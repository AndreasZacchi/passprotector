<script lang="ts">
	let images = [
		...
		},
		{
			...
			src: '/22.jpg',
			review:
				'"Absolutely amazing. I use this password manager to keep my password for my child porno!"'
		}
	];
...
<div class="grid place-items-center gap-6 justify-center items-center py-10">
	...
	{#each images as image, i}
		<div
			class={` row-start-2 carousel-card flex flex-col h-[22rem] w-[25rem] rounded-2xl shadow-xl ${

	...
	<div class="bg-blue-50 w-12/12 py-[18vh] px-[18vw] flex flex-row place-items-center">
		...
		<div class="w-7/12">
			...
			<ul class="my-10">
				...
				<li class="flex flex-row">
					<img class="h-5" src="checkmark.png" alt="checkmark" />
					<h3 class="ml-2 mb-3 text-xl">Password generation</h3>
				</li>
				<li class="flex flex-row">
					<img class="h-5" src="checkmark.png" alt="checkmark" />
			...
			<!--Try for free button-->
			<Button destination="/auth/register" text="Try PassProtector for Free" textSize="xl" />
		</div>
		...
		<div>
			...
			<div>
				...
				<div id="review" class="">
					...
					<span class="mb-1 text-black"> Bedre end badene i Auschwitz </span>
				</div>
			</div>
		</div>
